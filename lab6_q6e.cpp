...
#include<iostream>
using namespace std;
//function to show the outputs of the sum of all even numbers between firstNumber and secondNumber.
//looping
...
//function to show the outputs the sum of all odd numbers between firstNumber and secondNumber.
//looping
