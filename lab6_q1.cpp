...
#include <iostream>
using namespace std;
//give the function that include the cost of the single unit,no of units, tax rate and returns the value for calling modules.
...
//The function that receives cost of the single unit,no of units, and tax rate and returns to the calling module the sales Tax and total cost.
void func2(int unitCst,int units, int taxRt, int &salesTx ,int &totdue){
	salesTx = (units*unitCst*taxRt/100);
	totdue = units*unitCst + salesTx;
} 

//Give the function that receives cost of the single unit,no of units,tax rate ,the sales Tax and total cost and outputs in readable format
...
//Give the required main function with the variables called unitCost, unitsPurch, taxRate, salesTax, and totalDue.
int main(){
